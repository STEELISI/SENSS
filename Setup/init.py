...
if type=="server":
	...
	try:
		cur.execute("CREATE TABLE `CONSTANTS` (`id` int(11) NOT NULL AUTO_INCREMENT, `as_name` varchar(45) NOT NULL, `controller_url` VARCHAR(250) NOT NULL, `rule_capacity` INT NOT NULL,`fair_sharing` INT NOT NULL, `revoke_all` INT NOT NULL, `auth_type` VARCHAR(250) NOT NULL, PRIMARY KEY (`id`))")
